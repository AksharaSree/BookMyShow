...
function UserNavbar ({children}) {
  return (
    <>
      <Navbar className='bg-color-nav1'>
        <div className='main-container'>
          ...
          <Navbar.Collapse className='justify-content-end'>
            <button type='button' className='btn btn-default btn-sign-in'>
              Sign In
            </button>
          </Navbar.Collapse>
        </div>
      ...
      <Navbar className='bg-color-nav2'>
        <div className='main-container'>
      ...
      <div className='super-container'>{children}</div>
